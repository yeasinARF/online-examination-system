...
import image from '../public/Image/ch.png'
                                    ...
                                    <Col xs={12} md={12} lg={6} xl={7} xxl={7}>
                                        <div className="content">
                                            ...
                                            <Card.Text>
                                                ...
                                                (i) Bulb will not glow because electrolyte is not acidic.<br></br>
                                                (ii) Bulb will glow because HCl is a strong acid and furnishes ions for conduction.<br></br>
                                                (iii) Bulb will not glow because circuit is incomplete.<br></br>
                                                (iv) Bulb will not glow because it depends upon the type of electrolytic solution.
                                            </Card.Text>
                                            <Image src={image} style={{ width: '170px', height: '180px' }}></Image>
                                            <hr style={{ marginRight: '-16px' }}></hr>
                                            <div className="my-2">
                                                <input type="radio" id="css" name="fav_language" value="CSS" checked={checked} onChange={() => setChecked(true)} />
                                                <label for="css" style={{ fontSize: '0.9rem' }}>(A).<span className="ps-2">i and ii</span></label><br></br><hr style={{ marginRight: '-16px' }}></hr>
                                                <input type="radio" id="cs" name="fav_language" value="CSS" checked={clicked} onChange={() => setClicked(true)} />
                                                <label for="cs" style={{ fontSize: '0.9rem' }}>(B). <span className="ps-2">i</span></label><br></br><hr style={{ marginRight: '-16px' }}></hr>
                                                <input type="radio" id="c" name="fav_language" value="CSS" checked={press} onChange={() => setPress(true)} />
                                                <label for="c" style={{ fontSize: '0.9rem' }}>(C).<span className="ps-2">ii</span></label><br></br><hr style={{ marginRight: '-16px' }}></hr>
                                                <input type="radio" id="g" name="fav_language" value="CSS" checked={tab} onChange={() => setTab(true)} />
                                                <label for="g" style={{ fontSize: '0.9rem' }}>(D).<span className="ps-2">ii and iii</span></label><br></br><hr style={{ marginRight: '-16px' }}></hr>
                                            </div>
                                        </div>
                                    </Col>
                                </Row>
