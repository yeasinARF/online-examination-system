...
import image from '../public/Image/math.png'
                                ...
                                <Row g={5}>
                                    <Col xs={12} md={12} lg={6} xl={5} xxl={7}>
                                        <div className="content">
                                            ...
                                            <Card.Text>
                                                This “math” question actually requires no math what ever. If you flip the image upside down, you’ll see that what you’re dealing with is a simple number sequence.
                                            </Card.Text>
                                    ...
                                    <Col xs={12} md={12} lg={6} xl={7} xxl={5}>
                                        <div className="content">
                                            ...
                                            <div className="my-2">
                                                ...
                                                <label for="css" style={{ fontSize: '0.9rem' }}>(A).<span className="ps-2">87</span></label><br></br><hr style={{ marginRight: '-16px' }}></hr>
                                                <input type="radio" id="cs" name="fav_language" value="CSS" checked={clicked} onChange={() => setClicked(true)} />
                                                <label for="cs" style={{ fontSize: '0.9rem' }}>(B). <span className="ps-2">90</span></label><br></br><hr style={{ marginRight: '-16px' }}></hr>
                                                <input type="radio" id="c" name="fav_language" value="CSS" checked={press} onChange={() => setPress(true)} />
                                                <label for="c" style={{ fontSize: '0.9rem' }}>(C).<span className="ps-2">6.38</span></label><br></br><hr style={{ marginRight: '-16px' }}></hr>
                                                <input type="radio" id="g" name="fav_language" value="CSS" checked={tab} onChange={() => setTab(true)} />
                                                <label for="g" style={{ fontSize: '0.9rem' }}>(D).<span className="ps-2">8.38</span></label><br></br><hr style={{ marginRight: '-16px' }}></hr>
                                            </div>
                                        </div>
                                    </Col>
                                </Row>
